...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(510, 40, 111, 22))
        ...
        self.widget1.setGeometry(QtCore.QRect(190, 10, 208, 22))
        self.widget1.setObjectName("widget1")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.widget1)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label_row = QtWidgets.QLabel(self.widget1)
        self.label_row.setObjectName("label_row")
        self.horizontalLayout_2.addWidget(self.label_row)
        self.spinBox_row = QtWidgets.QSpinBox(self.widget1)
        ...
        self.label_col = QtWidgets.QLabel(self.widget1)
        self.label_col.setObjectName("label_col")
        self.horizontalLayout_2.addWidget(self.label_col)
        self.spinBox_col = QtWidgets.QSpinBox(self.widget1)
        ...
        self.widget2.setGeometry(QtCore.QRect(510, 430, 131, 22))
        self.widget2.setObjectName("widget2")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.widget2)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_groupNum = QtWidgets.QLabel(self.widget2)
